...
<div class="cart-small">
	<?if ($arResult["READY"] == "Y"):?>
		<a href="/personal/basket/" target="_self"><img src="<?=SITE_TEMPLATE_PATH?>/img/basket_img.png">Ваша корзина [<?=$arResult['QUANTITY']?>]</a>
    ...
    vertical-align: middle;" src="<?=SITE_TEMPLATE_PATH?>/img/basket_img.png"> Ваша корзина пуста
	<?endif;?>
</div>