...
<div class="bx-detail-element" id="<?= $itemIds['ID'] ?>">
    <div class="row">
        <div class="col-sm-4">
                ...
                <div class="product-item-detail-slider-block
                    ...
                    <div class="product-item-detail-slider-images-container" data-entity="images-container">
					    ...
					    if (!empty($actualItem['MORE_PHOTO']))
					    {
						    ...
						    {   if ($photo['WIDTH']>1000 || $photo['HEIGHT'] > 1000  ) {
					            ...
					            case 'price':
                                    ...
                                    <?}?>
	                                    ...
	                                    if ($arParams['SHOW_OLD_PRICE'] === 'Y')
	                                    {
                                            ...
                                            <div class="qty">Наличие: <?echo (!empty($arResult['PROPERTIES']['QTY']['VALUE']))? '<b>'.$arResult['PROPERTIES']['QTY']['VALUE'].'</b>' : '<b>Много</b>'?> </div>
                                            <!-- /.qty -->
                ...
                <div class="col-sm-12">
                    ...
                    <div class="product-item-detail-info-section">
                        ...
                        <ul class="uslugi">
	                        ...
	                        { ?>
		                       <li data-id="<?= $usluga['ID'] ?>" class="usluga_item"><?= $usluga['NAME'] ?>:
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Теперь Вам не нужно приезжать в офис и ждать решение банка о выдаче кредита - достаточно оформить
                        заказ на сайте и заполнить online-анкету. После получения положительного решения от банка о
                        выдаче кредита, Вы сможете подъехать в наш офис, заполнить уже подготовленные для Вас документы и
                        забрать свой заказ.</p>

                    <p><b>Заявку на online-кредит можно заполнить при оформлении заказа в корзине</b></p>
                    <p>
                        Просим Вас направлять online заявки на кредит в день планируемого посещения нашего офиса.
                        Кредитное решение действительно до окончания рабочего дня.
                    </p>
                </div>
