...
else
{
	...
	else
	{
		...
		?>
		<br /><br />
		<div class="title"><?=GetMessage("SOA_TEMPL_SUM_COMMENTS")?></div>
		...
		{
			?>
				</div> <div style="float:left; width:100%; padding-bottom:15px">

               <input type="checkbox" id="chk1"/>
    <label for="chk1" >*Я прочел, и согласен с условиями <a target="_blank" href="https://1090983.ru/agree/">Соглашения</a>.</label>
    
    </div><div id="butcont" class="disabled" >
				<input type="hidden" name="confirmorder" id="confirmorder" value="Y">
				<input type="hidden" name="profile_change" id="profile_change" value="N">
				<input type="hidden" name="is_ajax_post" id="is_ajax_post" value="Y">
				<input type="button" name="submitbutton" onClick="submitForm('Y');" value="<?=GetMessage("SOA_TEMPL_BUTTON")?>" class="btn btn-success"></div>
			</form>
