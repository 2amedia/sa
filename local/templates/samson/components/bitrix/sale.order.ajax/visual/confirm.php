...
{
	?>
	<div class="title"><?=GetMessage("SOA_TEMPL_ORDER_COMPLETE")?></div><br>
	<p><?= GetMessage("SOA_TEMPL_ORDER_SUC", Array("#ORDER_DATE#" => $arResult["ORDER"]["DATE_INSERT"], "#ORDER_ID#" => $arResult["ORDER_ID"]))?></p><br /><br />
	<?
	if (!empty($arResult["PAY_SYSTEM"]))
	{
		...
		<table class="sale_order_full_table">
			<tr>
				<td class="logo">
					<div class="title"><?=GetMessage("SOA_TEMPL_PAY")?></div>
