...
else
{
	...
	)
	{
		...
		$next_url = CUtil::JSEscape($APPLICATION->GetCurPageParam($strParams, array("PAGEN_".$arResult["PAGE_NAVNUM"], "RELOAD", "logajax")));
	...
	{	
		...
		{
			?><a style="display: none;" href="javascript:void(0);" id="sonet_log_more_container_first" class="feed-new-message-informer feed-new-message-inf-bottom"><span class="feed-new-message-inf-text"><?=GetMessage("SONET_C30_MORE")?><span class="feed-new-message-icon"></span></span><span class="feed-new-message-inf-text feed-new-message-inf-text-waiting" style="display: none;"><span class="feed-new-message-wait-icon"></span><?=GetMessage("SONET_C30_T_MORE_WAIT")?></span></a><?
		}
	}
	else
	{
