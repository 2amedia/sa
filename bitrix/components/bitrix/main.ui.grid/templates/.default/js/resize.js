;(function() {
	...
	BX.Grid.Resize.prototype = {
		init: function(parent)
		{
			...
			BX.addCustomEvent(window, 'Grid::headerPinned', BX.proxy(this.registerPinnedTableButtons, this));
		...
		destroy: function()
		{
			BX.removeCustomEvent(window, 'Grid::headerPinned', BX.proxy(this.registerPinnedTableButtons, this));
