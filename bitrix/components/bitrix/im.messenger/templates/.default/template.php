...
<div id="bx-notifier-panel" class="bx-notifier-panel">
	...
	</span><span class="bx-notifier-indicators"><a href="javascript:void(0)" class="bx-notifier-indicator bx-notifier-message" title="<?=GetMessage(IsModuleInstalled('intranet')? 'IM_MESSENGER_OPEN_MESSENGER_CP': 'IM_MESSENGER_OPEN_MESSENGER');?>"><span class="bx-notifier-indicator-text"></span><span class="bx-notifier-indicator-icon"></span><span class="bx-notifier-indicator-count"></span>
