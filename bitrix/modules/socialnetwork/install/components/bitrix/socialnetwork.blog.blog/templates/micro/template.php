			...
			<div class="<?=$className?>">
				<div class="blog-post-info">
					...
					$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"PATH_TO_USER_PROFILE" => ($arParams["USE_SOCNET"] == "Y" ? $arParams["~PATH_TO_SONET_USER_PROFILE"] : $arParams["~PATH_TO_USER"])
						),
						$component,
						array("HIDE_ICONS" => "Y")
					);?>
				...
				<div class="blog-post-meta">
					...
					<div class="blog-post-meta-util">
						...
						<?endif;?>
						<?if ($arParams["SHOW_RATING"] == "Y"):?>
							<span class="blog-post-rating rating_vote_text">
							<span class="blog-vert-separator"></span>
							<?
							$APPLICATION->IncludeComponent(
								"bitrix:rating.vote", $arParams["RATING_TYPE"],
					...
					<?if(strlen($CurPost["urlToOwner"]) > 0):?>
						<div class="blog-post-blog-owner"><?=$CurPost["ownerPrefix"]?> <a href="<?=$CurPost["urlToOwner"]?>"><?=$CurPost["ownerName"]?></a></div>
					<?endif;?>
				</div>
			</div>
		<?
