...
if ($ID > 0)
{
	...
	$aContext[] = 	array(
		...
		"LINK"	=> "javascript:if(confirm('".GetMessage("LEARNING_CONFIRM_DEL_MESSAGE")."'))window.location='learn_lesson_admin.php?COURSE_ID=".$COURSE_ID."&action=delete&ID=".$ID."&lang=".LANG."&".bitrix_sessid_get().urlencode(GetFilterParams("filter_", false))."';",
	);
...
<?$tabControl->arParams["FORM_ACTION"] = $APPLICATION->GetCurPage()."?lang=".LANG."&COURSE_ID=".$COURSE_ID.GetFilterParams("filter_");?>
<?$tabControl->Show();?>
