...
Class tcsbank_kupivkredit extends CModule
{
	...
	function DoInstall()
	{
		...
		RegisterModuleDependences("sale", "OnSaleCancelOrder", $this->MODULE_ID, "CTCSBank", "OnCancelOrder");
		RegisterModuleDependences("sale", "OnBeforeOrderDelete", $this->MODULE_ID, "CTCSBank", "OnDeleteOrder");
        RegisterModuleDependences("main", "OnPageStart", $this->MODULE_ID, "CTCSBank", "ShowUserScripts");
        RegisterModuleDependences("sale", "OnSaleComponentOrderOneStepPaySystem", $this->MODULE_ID, "CTCSBank", "CheckPaySystem");
		RegisterModuleDependences("main", "OnEndBufferContent", $this->MODULE_ID, "CTCSBank", "OnEndBufferContent");
	...
	function DoUninstall()
	{
		...
		elseif($step==2)
		{
			...
			$this->UnInstallFiles();
			$GLOBALS["errors"] = $this->errors;
			UnRegisterModuleDependences("sale", "OnBeforeOrderDelete", $this->MODULE_ID, "CTCSBank", "OnDeleteOrder");
			UnRegisterModuleDependences("sale", "OnSaleCancelOrder", $this->MODULE_ID, "CTCSBank", "OnCancelOrder");
            UnRegisterModuleDependences("main", "OnPageStart", $this->MODULE_ID, "CTCSBank", "ShowUserScripts");
			UnRegisterModuleDependences("sale", "OnSaleComponentOrderOneStepPaySystem", $this->MODULE_ID, "CTCSBank", "CheckPaySystem");
			UnRegisterModuleDependences("main", "OnEndBufferContent", $this->MODULE_ID, "CTCSBank", "OnEndBufferContent");
