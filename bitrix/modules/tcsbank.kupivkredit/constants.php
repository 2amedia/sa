<?
	...
	$arHosts = Array(
		"test"=>Array(
			"SRC"=>"https://kupivkredit-test-fe.tcsbank.ru",
			"API"=>"https://kupivkredit-test-api.tcsbank.ru",
	...
	$arReturnType = Array(
		"failed"=>GetMessage("TCS_return_failed"),
		"partial"=>GetMessage("TCS_return_partial"),
		"full"=>GetMessage("TCS_return_full")
	);
	$arRoundMethods = Array(
		"no_round"=>GetMessage("TCS_no_round_round"),
...
$arTCSMessage = array(
    ...
    '9030' => array(
        'ENG' => 'Invalid completion code',
        'RUS' => GetMessage("TCS_ERROR_9030")
    ),
 );
