...
class CIMChat
{
	...
	function GetLastMessageLimit($chatId, $messageStartId, $messageEndId = 0, $loadExtraData = false, $bTimeZone = true)
	{
	...
	public function AddUser($chatId, $userId, $hideHistory = null, $skipMessage = false)
	{
		global $DB;
		...
		{
			$hideHistory = true;
			$maxId = $arRelation[$this->user_id]['START_ID']-1;
		}
