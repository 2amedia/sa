...
class CIMHistory
{
	...
	public function GetMessagesByDate($chatId, $date, $messageStart = 0, $timezone = true)
	{
		...
		while ($message = $result->Fetch())
		{
			...
			$arMessages[$message['ID']] = Array(
				...
				'text' => $CCTP->convertText(htmlspecialcharsbx($message['MESSAGE']))
			);
	...
	public function GetRelatedMessages($messageId, $previous = 10, $next = 10, $timezone = true)
	{
		...
		foreach ($messages as $mess)
		{
			...
			$arMessages[$mess['ID']] = Array(
				...
				'text' => $CCTP->convertText(htmlspecialcharsbx($mess['MESSAGE']))
			);
