...
$MESS["SBLP_DDESCR"] = "Payment bill for printing. Opens in a new window.";
...
$MESS["SBLP_BANK_ACCNO_SUPPLI"] = "Supplier account no.";
$MESS["SBLP_BANK_ACCNO_SUPPLI_DESC"] = "Supplier (seller) account number";
$MESS["SBLP_BANK_ACCNO_SUPPLI_VAL"] = "Supplier account no.";
$MESS["SBLP_BANK_SUPPLI"] = "Name of Seller's bank";
$MESS["SBLP_BANK_SUPPLI_DESC"] = "Name of bank where seller's account is located";
$MESS["SBLP_BANK_SUPPLI_VAL"] = "Supplier bank";
...
$MESS["SBLP_BANK_IBAN_SUPPLI"] = "Supplier IBAN";
$MESS["SBLP_BANK_IBAN_SUPPLI_DESC"] = "Supplier (seller) IBAN";
$MESS["SBLP_BANK_IBAN_SUPPLI_VAL"] = "Supplier IBAN";
$MESS["SBLP_BANK_SWIFT_SUPPLI"] = "Supplier bank SWIFT";
$MESS["SBLP_BANK_SWIFT_SUPPLI_DESC"] = "Supplier (seller) bank SWIFT";
$MESS["SBLP_BANK_SWIFT_SUPPLI_VAL"] = "Supplier bank SWIFT";

$MESS["SBLP_EU_INN_SUPPLI"] = "Supplier VAT ID";
$MESS["SBLP_EU_INN_SUPPLI_DESC"] = "Supplier (seller) VAT ID";
$MESS["SBLP_INN_SUPPLI"] = "Supplier national ID";
$MESS["SBLP_INN_SUPPLI_DESC"] = "Supplier (seller) national ID";
$MESS["SBLP_REG_SUPPLI"] = "Registered in";
$MESS["SBLP_REG_SUPPLI_DESC"] = "Companies House registration details";
...
$MESS["SBLP_PRINT"] = "Stamp (recommended display size: 150x150&nbsp;px)";
$MESS["SBLP_PRINT_DESC"] = "Supplier stamp image (recommended display size: 150x150)";
$MESS["SBLP_LOGO"] = "Supplier log (recommended size: 80x80&nbsp;px)";
$MESS["SBLP_LOGO_DESC"] = "Supplier log (recommended size: 80x80&nbsp;px)";
