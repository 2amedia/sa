...
?>
	...
	<tr><td>
		...
		<table cellpadding="2" cellspacing="1" border="0" width="100%">
			...
			?>
			<tr>
				<td class="tablebody" align="right"><font class="tablebodytext"><b><?echo GetMessage("SALE_CONTENT_SUMM")?>:</b></font></td>
				<td class="tablebody" align="right" colspan="2"><font class="tablebodytext"><?echo SaleFormatCurrency($ORDER_PRICE, $BASE_LANG_CURRENCY) ?></font></td>
			</tr>
			<tr>
				<td class="tablebody" align="right"><font class="tablebodytext"><b><?echo GetMessage("SALE_CONTENT_DISCOUNT")?>:</b></font></td>
				<td class="tablebody" align="right" colspan="2"><font class="tablebodytext"><?echo SaleFormatCurrency($DISCOUNT_PRICE, $BASE_LANG_CURRENCY) ?>
			...
			if (is_array($arTaxList) && count($arTaxList)>0):
				foreach ($arTaxList as $key => $val):
					...
					<tr>
						...
						<td class="tablebody" align="right" colspan="2">
			...
			<table border="0" cellspacing="0" cellpadding="3" width="100%">
				<tr>
					<td class="tablebody">
						...
						<?= str_replace("#LINK#", htmlspecialchars($PERSONAL_PAGE), GetMessage("STO_ORDER_HINT")) ?><br><br>
						<?= str_replace("#LINK#", htmlspecialchars($PERSONAL_PAGE), GetMessage("STO_ORDER_HINT_ANN")) ?><br><br>
				...
				if (IntVal($arOrder["PAY_SYSTEM_ID"]) > 0)
				{
					...
					if ($arPaySysAction = $dbPaySysAction->Fetch())
					{
						...
						<tr>
								<td class="tablebody"><font class="tabletitletext"><p><hr width="100%" ></p><b><?echo GetMessage("STOF_ORDER_PAY_ACTION")?></b></font></td>
						</tr>
						<tr>
								<td class="tablebody">
									<font class="tablebodytext">
