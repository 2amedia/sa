...
class ShipmentImport extends EntityImport
{
    ...
    /**
     * @param Exchange\ICollisionShipment $collision
     * @throws Main\ArgumentException
     */
    public function loadCollision($collision)
    {
        if(!($collision instanceof Exchange\ICollisionShipment))
            throw new Main\ArgumentException("Collision must be instanceof ICollisionShipment");
