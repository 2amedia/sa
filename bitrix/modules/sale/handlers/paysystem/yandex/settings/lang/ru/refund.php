...
$MESS['SALE_YANDEX_RETURN_ERROR_SHOP_ID'] = "Прежде, чем настраивать возвраты, необходимо заполнить настройки обработчика платежной системы для данного типа плательщика:<br> <ul><li>Идентификатор магазина в ЦПП (ShopID)</li><li>Название компании</li></ul>";
