...
class ListsElementAttachedCrmComponent extends CBitrixComponent
{
	...
	protected function getEntityData()
	{
		...
		$entityType = \CCrmOwnerTypeAbbr::resolveName(\CCrmOwnerTypeAbbr::resolveByTypeID(
			$this->arParams['ENTITY_TYPE']));

		$this->entityData = \CCrmEntitySelectorHelper::prepareEntityInfo($entityType, $entityId, array(
			'ENTITY_EDITOR_FORMAT' => true,
			'REQUIRE_REQUISITE_DATA' => false,
			'REQUIRE_MULTIFIELDS' => false,
			'NAME_TEMPLATE' => \Bitrix\Crm\Format\PersonNameFormatter::getFormat()
		));
		$this->entityData['idWithPrefix'] = $this->entityIdWithPrefix;
	}
