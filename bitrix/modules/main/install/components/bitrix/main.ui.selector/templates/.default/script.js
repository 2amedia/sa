;(function() {
	...
	BX.Main.Selector.prototype = {
		init: function(params)
		{
			...
			if (this.input)
			{
				BX.bind(this.containerNode, "click", BX.delegate(this.initDialog, this));
				if (this.tag)
				{
		...
		addData: function(data, callback)
		{
			...
			if (typeof data['ITEMS_LAST']['USERS'] != 'undefined')
			{
				BX.SocNetLogDestination.obItemsLast[this.id]['users'] = data['ITEMS_LAST']['USERS'];
			}
			if (typeof data['ITEMS_LAST']['SONETGROUPS'] != 'undefined')
			{
				BX.SocNetLogDestination.obItemsLast[this.id]['sonetgroups'] = data['ITEMS_LAST']['SONETGROUPS'];
			}
			if (typeof data['ITEMS_LAST']['DEPARTMENT'] != 'undefined')
			{
				BX.SocNetLogDestination.obItemsLast[this.id]['department'] = data['ITEMS_LAST']['DEPARTMENT'];
			}
			if (typeof data['ITEMS_LAST']['GROUPS'] != 'undefined')
			{
				BX.SocNetLogDestination.obItemsLast[this.id]['groups'] = data['ITEMS_LAST']['GROUPS'];
			}
			if (
