	...
	implements IBPEventActivity, IBPActivityExternalEventListener
{
	...
	public function OnExternalEvent($arEventParameters = array())
	{
		...
		if (!$this->IsPropertyExists("SetStatusMessage") || $this->SetStatusMessage == "Y")
		{
			...
			if ($approvers == "")
				$approvers = GetMessage("BPAA_ACT_APPROVERS_NONE");
			if ($rejecters == "")
				$rejecters = GetMessage("BPAA_ACT_APPROVERS_NONE");

			$this->SetStatusTitle(str_replace(
				array("#PERC#", "#PERCENT#", "#REV#", "#VOTED#", "#TOT#", "#TOTAL#", "#APPROVERS#", "#REJECTERS#"),
				array($votedPercent, $votedPercent, $votedCount, $votedCount, $totalCount, $totalCount, $approvers, $rejecters),
				$messageTemplate
			));
		}
