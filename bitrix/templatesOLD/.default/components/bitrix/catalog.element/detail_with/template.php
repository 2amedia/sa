...
<? } else { ?>
	...
	<span> -> </span>
	<span><?=$arResult["NAME"]?></span>
<?}} else if($section_id['ID'] == 119) { ?>
	<span><a href="/">Главная</a></span>
	<span> -> </span>
	<span><a href="/Netshop/zima/">Зимние товары</a></span>
	<span> -> </span>	
	<span><a href="/Netshop/zima/podzakaz/">Под заказ</a></span>
	<span> -> </span>
	<span><?=$arResult["NAME"]?></span>
<? } else {?>
	<span><a href="/">Главная</a></span>
...
<? foreach ($arResult["PROPERTIES"]["ADD_PHOTO_IN_DETAIL"]["VALUE"] as $value) { ?>	
	<? 
		...
		$small = CFile::ResizeImageGet($value, array('width' => 70, 'height' => 70), BX_RESIZE_IMAGE_EXACT, true);
	?>
			<td style="text-align:center;border: 1px solid #99CC00;padding: 5px;"><a style="text-decoration:none;padding:5px;background-image: none;" rel="lightbox[1]" href="<?=$big['src']?>" class="lightbox-enabled">
