...
<div class="cart-small">
	<?if ($arResult["READY"] == "Y"):?>
		<a href="/personal/basket/" target="_self"><img src="/images/korz.jpg">Ваша корзина [<?=$arResult['QUANTITY']?>]</a>
		<div class="cart-popup-wrapper<?if ($arParams['SHOW_CART'] == 'Y'):?> js-active<?endif?>">
			<div class="cart-popup">
				...
				<div class="cart-popup-footer">
					...
					<?if ($arResult['PRICE'] >= 5000):?>
						<a class="cart-small-order" target="_self" href="<?=$arParams['PATH_TO_ORDER']?>">Оформить заказ</a>
					<?else:?>
						<div class="cart-small-min">Минимальная сумма заказа - 5 000 руб.</div>
					<?endif?>
				</div>
			</div>
		</div>
    ...
    vertical-align: middle;" src="/images/korz.jpg"> Ваша корзина пуста
	<?endif;?>
</div>