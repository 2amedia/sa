...
?>
		...
		<?}else{?>
			...
			<a style="display:block" href="/Netshop/choice/metalstreet/<?=$arSection["CODE"]?>/<?=$url?>.html"><?=$arSection["NAME"]?>
			</a>
		<? } else { ?>
		...
		<? } ?>
          ...
          <? if($arSection["IBLOCK_SECTION_ID"] == '4') { ?>
			<a style="display:block" href="/Netshop/choice/matlal/<?=$arSection["CODE"]?>/<?=$url?>.html" ><?=$arSection["NAME"]?>
			</a>
		<? } else { ?>
