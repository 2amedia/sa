...
<div class="history">
<a href="#" data-reveal-id="myModal">Это интересно!</a>
</div>
...
<div class="content-history">
     <div class="content-text">
    <?php /*?><i>Шведская стенка &mdash; гимнастический снаряд из вертикальных стоек с поперечными округлыми перекладинами (лестница). Изобретателем шведской стенки в её нынешнем виде стал в начале 19 века П. Линг. Подобные снаряды и упражнения с их использованием описывались ещё в 1793 году немецким педагогом И. Гутс-Мутс в его труде &laquo;Гимнастика для юношества&raquo;. В России этот товар выпускался под названием &ldquo;Детский спортивный комплекс (ДСК) “Юниор&rdquo; («Юниор», «Чемпион» и др.). НП предприятием «Калужский приборостроительный завод «Тайфун» с 1992 года.</i><?php */?>
     <p><?=htmlspecialcharsBack($arResult["PROPERTIES"]["TEXT_HISTORYIMP"]["VALUE"]["TEXT"])?></p>
     </div>
     <a class="close-reveal-modal"></a>
</div>
...
<div class="history">
<a href="#" data-reveal-id="myModal">Заливаем горку</a>
</div>
...
<div class="clearfix" style="font-family: Tahoma,Geneva,sans-serif;text-align: left; margin:0 0 15px 0; float:left">
...
<?php /*?> <? if (CSite::InDir("/Netshop/derevostreet/brem/brem_50.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; "><s><? echo number_format( 40000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?><?php */?>

<?php /*?> <? if (CSite::InDir("/Netshop/derevostreet/mon/mon_51.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 35000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	
    
 <? if (CSite::InDir("/Netshop/derevostreet/malta/malta.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 30000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?> 
     <? if (CSite::InDir("/Netshop/derevostreet/goa/goa_besed.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 15000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?> 

     <? if (CSite::InDir("/Netshop/derevostreet/arena-pesochnitsa/arena-pesochnitsa.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 12000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?> 
      <? if (CSite::InDir("/Netshop/derevostreet/pesochnitsa-ladya/ladya.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 20000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?> 
    
       <? if (CSite::InDir("/Netshop/derevostreet/sandbox_roof/sandbox_2.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 10500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/derevostreet/sandbox/sandbox_1.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 5500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?><? } ?>
    
      <? if (CSite::InDir("/Netshop/derevostreet/taz/taz_48.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 60000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/derevostreet/bret/bret_45.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 60000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
...
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
    <? if (CSite::InDir("/Netshop/derevostreet/kir/kir_49.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 60000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
...
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/derevostreet/am/am_47.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 50000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/derevostreet/assol/assol.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 85000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/derevostreet/baunti/baunti.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 85000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/derevostreet/fortuna/fortuna.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 85000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
       <? if (CSite::InDir("/Netshop/derevostreet/taiti/diptaiti.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 95000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/derevostreet/fregat-novinka-/fregat.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 130000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
    <? if (CSite::InDir("/Netshop/derevostreet/karavella-novinka/karavella.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 170000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?><?php */?>
      ...
      <?php /*?><? if (CSite::InDir("/Netshop/sad/skameyka/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 5000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
    
      <? if (CSite::InDir("/Netshop/sad/stol-dachnyy/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 12000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
 <? if (CSite::InDir("/Netshop/sad/lavka-so-spinkoy/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 7000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
    <? if (CSite::InDir("/Netshop/sad/skameyka-s-vazonami-novinka/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 9000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/sad/stol-dachnyy-universalnyy/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 10500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
        <? if (CSite::InDir("/Netshop/sad/skameyka-dvukhmestnaya/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 10500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/sad/skameyka-trekhmestnaya/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 15000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/sad/stol-dachnyy-bolshoy-novinka-/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 15000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/sad/vazon-malyy/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 4500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/sad/vazon-sredniy/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 5500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/sad/vazon-bolshoy/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 6500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
    <? if (CSite::InDir("/Netshop/sad/pergola-malaya/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 25000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
    <? if (CSite::InDir("/Netshop/sad/pergola-bolshaya-venge/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 50000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?>
     <? if (CSite::InDir("/Netshop/sad/dekorativnyy-zabor/")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 2000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">СКИДКА 20%</div>
	<? } ?><?php */?>
    
      <? if (CSite::InDir("/Netshop/kiddyloft/valli/wally.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 40000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/kiddyloft/nemo/nemo.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 36500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/kiddyloft/sonic/rose.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 35500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/kiddyloft/skubi/rolix.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 27000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
    
        <? if (CSite::InDir("/Netshop/kiddyloft/dori-novinka/dori.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 36500, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
    
        <? if (CSite::InDir("/Netshop/kiddyloft/vendi-novinka-/vendi.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 36000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
    
     <? if (CSite::InDir("/Netshop/kiddyloft/patrik-novinka-/patrik.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 49900, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
      <? if (CSite::InDir("/Netshop/kiddyloft/vinni/vinny.html")){?>
		<div style="text-align:left; margin:5px 0 0px 0;"><span style="font-family: Tahoma,Geneva,sans-serif; font-size: 20px"><s><? echo number_format( 43900, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-family: Tahoma,Geneva,sans-serif;
    font-size: 20px; color:#000">АКЦИЯ</div>
	<? } ?>
...
<? if (CSite::InDir("/Netshop/derevostreet/mad/mad_46.html")){?>
<div style="text-align:left; margin:0 0 0px 0;"><span style="font-size:14px;"><br><s><? echo number_format( 60000, 0, ',', ' ' ); ?> руб.</s><br></div>
<div style=" display:block;  "><span style="font-size:14px; color:#000; font-weight:bold ">СКИДКА 25%</div><?}?><?php */?>
