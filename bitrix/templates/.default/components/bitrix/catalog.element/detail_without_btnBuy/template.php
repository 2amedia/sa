...
<? foreach ($arResult["PROPERTIES"]["ADD_PHOTO_IN_DETAIL"]["VALUE"] as $value) { ?>	
	...
	?>
			<td style="text-align:center;border: 1px solid #CCCCCC;padding: 5px;"><a style="text-decoration:none;padding:5px;background-image: none;" rel="lightbox[1]" href="<?=$big['src']?>" class="lightbox-enabled">
				...
				<div class="box_for_gallery">	
					<ul class="container_for_slides">
						...
						while($arItem = $dbItems->GetNext())
						{
							...
							$get_prd = GetCatalogProduct($arItem["ID"]);						
