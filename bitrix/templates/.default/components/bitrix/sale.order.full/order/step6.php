...
<tr>
	<td valign="top" width="60%">
		...
		{
			?>
		<div class="no_print"><div style="float:left;"><b><?echo GetMessage("STOF_ORDER_CREATED")?></b></div>
				<div style="float:right;"><b><a href="javascript:print('')" style="font-size: 14px;" >распечатать квитанцию</a></b></div>
		</div><br /><br />
			
			<table class="sale_order_full_table">
				<tr>
					<td>
						<?= str_replace("#ORDER_DATE#", $arResult["ORDER"]["DATE_INSERT_FORMATED"], str_replace("#ORDER_ID#", $arResult["ORDER_ID"], GetMessage("STOF_ORDER_CREATED_DESCR"))); ?><br /><br />
						...
						<tr>
							<td>
								...
								else
								{
									...
									{
										//print_r($arResult["PAY_SYSTEM"]["PATH_TO_ACTION"]);
	...
	<td class="no_print" valign="top" width="5%">&nbsp;</td>
	<td class="no_print" valign="top" width="35%">
