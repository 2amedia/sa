							...
							<tbody>
								<tr> 
									<td class="lefttd" style="text-align: center;">
										<a  href="/"><img style="width:310px" align="left"  src="/images/logo-vesna3.jpg" ></a>	
									</td> 
									<td>
...
//												)
//											);?>
											<div class="leftmenu"> <span style=" color: #2a3779;font-size: 13px; font-weight:bold">Каталог товаров:</span><br><br>
					 							...
					 							<div class="level_1_yellow">
						 							...
						 							<div class="rumb">
                                                    	<a href="/Netshop/sad/"><b>Малые архитектурные формы <br>для сада и дачи (МАФ)</b></a>
					 									<?
												...
												</div><div class="level_1_kiddy">
					 								<div class="rumb">
					 									<a href="/Netshop/kiddyloft/"><b class="<?=$APPLICATION->GetCurDir()?>">Детский игровой ЧЕРДАК<br> для дома и дачи</b></a>
					 									<?
														if(strpos($APPLICATION->GetCurDir(),"Netshop/kiddyloft/")>0) $kiddy=true;
														if($_GET["CODE"])
													 	{
														...
														if($kiddy)
														{
																...
																echo "</div>";
																echo "<div class=\"items\">";
															$arFilter = Array("IBLOCK_ID"=>3, "ACTIVE"=>"Y", "SECTION_ID"=>238);
															$sres = CIBlockSection::GetList(Array("sort"=>"asc"), $arFilter, true);
															while($ar_result = $sres->GetNext())
															{
																if($ar_result["ID"]==$section_id)
																...
																else
																{
																	...
																	echo "<a href=\"/Netshop/kiddyloft/".$ar_result["CODE"]."/".$arFields["CODE"].".html\">".$ar_result["NAME"]."</a><br>";
																}
															}
														}
					 									?>
												...
												<?php /*?><div class="level_1_red">
					 							...
					 							<div class="level_1_blue">
					 								<div class="rumb">
					 									<a href="/Netshop/dop/"><b>Дополнительное оборудование к ДИП, ДСК, УДСК, МАФ</b></a>
					 									<?
					 							...
					 							<div class="grayforwintergoods">
						 							<div class="rumb">
						 								<a href="/Netshop/zima/"><b>Зимние игровые деревянные горки (ЗИГ)</b></a>
					 									<?
...
<div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,moimir,gplus,twitter,evernote,linkedin,lj,viber,whatsapp" data-size="s"></div>
									 ...
									 <td style="top:-50px; position: relative; height: 180px" align="left"> 
										<table width="100%">
											<tbody>
