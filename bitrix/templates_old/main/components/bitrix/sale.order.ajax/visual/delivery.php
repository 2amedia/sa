...
<div class="section">
	...
	<table class="sale_order_table props">
		<?PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"], array(2, 10));?>
	</table>
	...
	<?if(!empty($arResult["DELIVERY"])):?>
		...
		<table class="sale_order_table props">
			<?
			if ($arResult['USER_VALS']['DELIVERY_ID'] == 2)
				PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"], array(11, 12));
			PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"], array(1, 6));
			?>
		</table>
	<?endif?>
</div>
